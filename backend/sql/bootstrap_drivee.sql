...
('c0000000-0000-0000-0000-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'done_rides', 'Завершенные поездки', 'Заказы с driverdone_timestamp', 'operations', 'metric', 'train', 'driverdone_timestamp', 'COUNT(CASE WHEN driverdone_timestamp IS NOT NULL THEN 1 END)', '{"unit":"rows"}', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1'),
