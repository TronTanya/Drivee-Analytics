...
def run_forecast(
    ...
    return ForecastRunResponse(
        ...
        strategy_summary={
            ...
            "selected_strategies": dict((result.forecasts or {}).get("selected_strategies") or {}),
            "data_quality": dict((result.forecasts or {}).get("data_quality") or {}),
            "backtest_summary": dict((result.forecasts or {}).get("backtest_summary") or {}),
